    ...
    <div className="grid lg:grid-cols-3 items-center gap-8">
      <div className="space-y-8 relative">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-[#1C140F] rounded-[50%] p-[10px] flex justify-center items-center cursor-pointer hover:scale-110 transition-all duration-300">
            <svg
              width="12"
              height="12"
              viewBox="0 0 12 12"
      ...
      >
        ...
        <div><p className="text-[20px]">+94 4444 5555 6</p></div>
      </a>
      <a
        href="#!"
        className="flex items-center gap-4 hover:text-[#FF7C32] transition-all duration-300"
      >
        ...
        <div><p className="text-[20px]">but also the leap into electronic typesetting</p></div>
      </a>
    </div>
  );
}
